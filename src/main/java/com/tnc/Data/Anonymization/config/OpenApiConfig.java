    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        ...
                        .version("2.0.0")
                        .description("A comprehensive REST API for anonymizing sensitive data using various strategies including pseudonymization, masking, and redaction. Requires JWT authentication for secure access.")
                        .contact(new Contact()
